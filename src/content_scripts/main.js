...
function mainJira() {
    if (!document.querySelector(".has-specification-button")) {
        ...
        if (toolbar && originalUl) {
            ...
            cloneUl.innerHTML = `<li class=\"toolbar-item\"><a id=\"comment-issue\" title=\"Comment on this issue\" class=\"toolbar-trigger issueaction-comment-issue add-issue-comment inline-comment\" href=\"${specificationTemplateURL}?title=${specificationTicketNumber}[[${specificationAccount}]]${specificationVersion} - Customization specification\" target=\"_blank\"><span class=\"icon aui-icon aui-icon-small aui-iconfont-comment icon-comment\"></span> <span class=\"trigger-label\">Specification</span></a></li>`
            ...
            toolbar.classList.add("has-specification-button")
        }
    }
