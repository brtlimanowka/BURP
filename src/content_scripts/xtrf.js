...
function getActiveButtonNames(array) {
    if (activeModule) {
        switch (activeMode) {
            case "Displaying":
                activeModule.buttonsDisplayMode.forEach(value => {
                    array.push(value);
                });
                break;
            case "Editing":
                activeModule.buttonsEditMode.forEach(value => {
                    array.push(value);
                });
                break;
            case "Creating":
                activeModule.buttonsCreateMode.forEach(value => {
                    array.push(value);
                });
                break;
        }
...
function cloneActiveButtons(inputArray, outputArray) {
    ...
    if (activeMode == "Editing" && (activeModule.name == "Client" || activeModule.name == "Provider")){
